...
(function() {
  ...
  Object.assign(W.STRINGS["es"], {
    ...
    agency_awards_none_open_data: "Los contratos adjudicados por esta agencia no se publican en ningún conjunto de datos abierto que CROL-List conozca.",
    ...
    external_award_none_note_html: "El sitio también consultó {source} y tampoco encontró ninguna adjudicación coincidente allí.",
    external_award_nycha_none_note: "El sitio consultó Checkbook NYC con el PIN de este aviso y aún no encontró ninguna adjudicación registrada allí — el registro puede tardar respecto a una licitación.",
    ...
    external_award_nycha_note_html: "Adjudicación de Checkbook NYC vinculada por el PIN exacto <code>{pin}</code> y una fecha de contrato posterior a esta licitación.",
    glance_who: "Quién",
    glance_what: "Qué",
    glance_when: "Cuándo",
    glance_act: "Actuar",
    ...
    no_zap_kw: " para “{kw}”",
    zap_explainer_html: "ZAP indexa por <b>proyecto</b>, no por dirección — un aviso sobre su manzana puede faltar aquí y aun así estar en <a href=\"https://a856-cityrecord.nyc.gov/Search/Advanced\" target=\"_blank\" rel=\"noopener noreferrer\">The City Record<span class=\"sr-only\"> (se abre en una pestaña nueva)</span></a>.",
    ...
    stats_desc_digests_alltime: "Todos los resúmenes que CROL-List ha enviado.",
    stats_lbl_nl_alltime: "Búsquedas realizadas · desde siempre",
    stats_desc_nl_alltime: "Cada pregunta en lenguaje llano que CROL-List ha respondido.",
    ...
    stats_p_bylens: "Sobre qué parte del sitio la gente preguntó: contratos, personal, terrenos, propiedades, normas o reuniones.",
    ...
    stats_p_technical: "Cómo funcionan las cifras de arriba. No necesita saber esto para usar CROL-List.",
