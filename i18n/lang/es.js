...
(function() {
  ...
  Object.assign(W.STRINGS["es"], {
    ...
    quiz_step2: "Acotar por palabra clave (opcional)",
    ...
    agency_awards_unavailable_note: "Ningún contrato adjudicado por esta agencia figura en el Registro Municipal — algunas agencias publican sus adjudicaciones en otro lugar.",
    glance_who: "Quién",
    glance_what: "Qué",
    glance_when: "Cuándo",
    glance_act: "Actuar",
    ...
    apply_pnote_no_email_html: "Este aviso no indica un contacto directo — envíe su respuesta a través de <b>PASSPort</b>, o use la dirección de envío indicada arriba, si figura alguna.",
    ...
    about_foot_html: "CROL-List · una interfaz de búsqueda sobre <a href=\"https://a856-cityrecord.nyc.gov/\" target=\"_blank\" rel=\"noopener noreferrer\">The City Record<span class=\"sr-only\"> (se abre en una pestaña nueva)</span></a> · <a href=\"changelog.html\">Registro de cambios</a> · <a href=\"stats.html\">Estadísticas</a> · <a href=\"index.html\">Inicio</a>",
    ...
    stats_h_alltime: "Desde el lanzamiento",
    stats_p_alltime: "Los mismos resultados, sumados desde el primer día en lugar de reiniciarse cada 7 días.",
    stats_lbl_digests_alltime: "Resúmenes enviados · desde siempre",
    stats_desc_digests_alltime: "Todos los resúmenes que CROL-List ha enviado, no solo los últimos 7 días.",
    stats_lbl_nl_alltime: "Búsquedas en lenguaje llano · desde siempre",
    stats_desc_nl_alltime: "Cada búsqueda en lenguaje llano jamás traducida, no solo las de hoy.",
    stats_h_category: "Por tema",
    stats_p_category: "Avisos mostrados en resúmenes desde el lanzamiento, desglosados por tema del Registro Municipal.",
    ...
    stats_p_history: "Resúmenes enviados y búsquedas en lenguaje llano, día por día.",
    stats_col_day: "Día",
    stats_col_digests: "Resúmenes enviados",
    stats_col_searches: "Búsquedas realizadas",
    stats_history_caption: "Conteos diarios de resúmenes enviados y búsquedas realizadas",
    ...
    api_p_upstream_html: "CROL-List republica y combina conjuntos de datos públicos — para trabajo masivo, vaya directo a las fuentes: <a href=\"https://data.cityofnewyork.us/City-Government/City-Record-Online/dg92-zbpx\">City Record Online (dg92-zbpx, Socrata SODA)</a> · <a href=\"https://www.checkbooknyc.com/data-feeds/api\" target=\"_blank\" rel=\"noopener noreferrer\">API de Checkbook NYC<span class=\"sr-only\"> (se abre en una pestaña nueva)</span></a> · <a href=\"https://data.cityofnewyork.us/City-Government/Citywide-Payroll-Data-Fiscal-Year-/k397-673e\">Nómina Municipal</a> · <a href=\"https://data.cityofnewyork.us/City-Government/Zoning-Application-Portal-ZAP-Project-Data/hgx4-8ukb\">ZAP</a>.",
    api_foot_html: "CROL-List · <a href=\"index.html\">Inicio</a> · <a href=\"about.html\">Acerca de</a>",
    chg_p_lede: "Qué cambió en CROL-List, lo más reciente primero.",
    chg_auto_h2: "Actualizaciones recientes",
    chg_auto_note: "Estas líneas provienen de las descripciones de los cambios de código fusionados y permanecen en inglés por ahora.",
