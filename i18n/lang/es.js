...
(function() {
  ...
  Object.assign(W.STRINGS["es"], {
    ...
    quiz_step2: "Refinar con una palabra clave exacta (opcional)",
    ...
    watch_moneynl: "Contratos o adjudicaciones que coincidan con una descripción",
    ...
    param_label_moneynl_kw: "Categoría o palabras clave (opcional)",
    param_label_moneynl_min: "Monto mínimo (opcional)",
    param_label_moneynl_months: "Vence dentro de, en meses (opcional)",
    ...
    prior_cycle_heuristic_note: "Coincide por agencia y título, no por un PIN compartido — es una conjetura heurística sobre el mismo contrato recurrente, no un vínculo garantizado. Verifique las fechas y el proveedor antes de confiar en ella.",
    prior_cycle_none_note: "No se encontró un ciclo anterior plausible para este caso — o no es recurrente, o una ronda anterior no coincidió lo suficiente como para mostrarla con confianza.",
