...
const STRINGS = {
  en: {
    ...
    stats_h_alltime: "Since launch",
    stats_p_alltime: "The same outcomes, added up since day one instead of reset every 7 days.",
    stats_lbl_digests_alltime: "Digests sent · all time",
    stats_desc_digests_alltime: "Every digest CROL-List has ever sent, not just the last 7 days.",
    stats_lbl_nl_alltime: "Plain-English searches · all time",
    stats_desc_nl_alltime: "Every plain-English search ever translated, not just today.",
    stats_h_category: "By topic",
    stats_p_category: "Notices surfaced in digests since launch, broken out by City Record topic.",
