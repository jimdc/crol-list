...
const STRINGS = {
  en: {
    ...
    about_li_privacy_html: "<li><b>Searches and filters</b> go from your browser straight to NYC Open Data. The CROL-List server never sees them.</li><li><b>The \"Ask\" box</b> lets you search in plain English. It sends your text to our worker. The worker then sends it to Anthropic's Claude, which turns your words into filters. We do not save your text. We only keep a daily count, so we can cap costs.</li><li><b>Subscribing or sending feedback</b> saves what you send us. This includes your alert or message and your email, if you share one. We also keep some basic info about your request, like your IP address and browser. We keep this for a short time to stop spam and abuse. Every alert email has a one-click unsubscribe link.</li><li><b>Page views</b> are tracked with Cloudflare Web Analytics. It uses no cookies and only shows totals. It counts visits. It does not know who you are or follow you to other sites.</li>",

    // data.html
    data_p_lede_html: "The City Record dataset at a glance. Your browser pulls live totals from <a href=\"https://data.cityofnewyork.us/City-Government/City-Record-Online/dg92-zbpx\">NYC Open Data</a>. Nothing is saved on the server. The numbers follow the <a href=\"about.html#data\">honesty rules</a>. Stats stay in their own section. Likely data-entry errors are excluded — amounts of $10B or more. Placeholder deadlines aren't counted as real.",
    ...
    data_note_agencies_html: "\"Cleaned\" means we took out amounts over $10B. We think those are data-entry errors. See <a href=\"about.html#data\">the underlying data</a>.",
